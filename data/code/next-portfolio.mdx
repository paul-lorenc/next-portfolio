...
<Image
  ...
  height={640}
  layout="responsive"
  alt="paul lorenc portfolio website"
/>

### [View The Project Here](https://paul-lorenc.com)
...
```bash
$ git clone longstringherehhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh
$ cd next-portfolio
$ npm install
```
